...
const Hero = ({ slice }: HeroProps) => {
  ...
  useGSAP(()=>{
    ...
    "+=.8"  // delay apres la precedente animation
  )
  .from(".hero-body",
    {
      opacity:0,
    ...
    >
      ...
      <div className="grid">
        <div className="grid h-screen place-items-center">
          <div className="grid auto-rows-min place-items-center items-center text-center">
        ...
        <div className="grid text-side relative z-[80] h-screen items-center gap-4 md:grid-cols-2">
          ...
          <div>
            <h2 className="text-side-heading text-balance text-6xl font-black uppercase
            text-sky-950 lg:text-8xl">
              <TextSplitter text= {asText(slice.primary.second_heading)} wordDisplayStyle="inline-block"/>
            </h2>
            <div className="text-side-body mt-4 max-w-4xl text-balance text-xl font-normal text-sky-950">
